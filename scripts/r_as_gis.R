...
# Let's take a moment to explore this raster file (it's metadata!):

r

# Projection is important! I typically set my teams GPS units to WGS84.
...
raster::extract(r_crop, dataSci_site)
...
### Challenge: Use piping and one of the prism paths to create, project, and crop a raster without generating intermediate objects (note: use the extent object we generated above).
...
extract(maxTemp_stack, dataSci_site)
